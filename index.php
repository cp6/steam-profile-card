    ...
    <div class="row content">
        ...
        <div class="col-lg-6">
            <div class="well">
                ...
                /*
                $mostid = "107410";
                $most = json_decode(file_get_contents("https://store.steampowered.com/api/appdetails?appids=" . $mostid . ""));
...
*/
                ...
                if ($data->profile_state == 0) {echo "<p  class='details'>Last on: " . time_elapsed_string($data->llo, $full = true) . "</p>";} else {};
                $rp1 = rp($steamid, 0);
                $rp2 = rp($steamid, 1);
                $rp3 = rp($steamid, 2);
                $rp4 = rp($steamid, 3);
